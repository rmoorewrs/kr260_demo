...
export SUB_PROJECT_NAME=${PROJECT_NAME}_a53_bench
export BSP_NAME=${BSP_NAME_A53}

# set DTS_FILE for benchmark (UART belongs to A53, no network)
export DTS_FILE=kr260-a53-bench.dts
...
vxprj vip parameter setstring SYSCLK_TIMER_NAME "armGenTimer"
vxprj vip parameter set SYSCLK_TIMER_NUM 0
vxprj vip parameter set SYS_CLK_RATE_MAX 1000
vxprj vip parameter set SYS_CLK_RATE 1000

vxprj vip parameter setstring TIMESTAMP_TIMER_NAME "armGenTimer"
vxprj vip parameter set TIMESTAMP_TIMER_NUM 0
...
echo "cp default/vxWorks.bin /tftpboot/vxWorks_a53_bench.bin"
